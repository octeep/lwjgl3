...
val Visual_p = struct(Module.CORE_OPENBSD, "Visual") {
...
val XVisualInfo_p = struct(Module.CORE_OPENBSD, "XVisualInfo") {
...
val XSetWindowAttributes_p = struct(Module.CORE_OPENBSD, "XSetWindowAttributes") {
