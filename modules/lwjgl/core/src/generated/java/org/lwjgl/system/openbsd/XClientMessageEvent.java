...
public class XClientMessageEvent extends Struct implements NativeResource {
    ...
    /**
     * Returns a new {@link XClientMessageEvent.Buffer} instance allocated on the thread-local {@link MemoryStack}.
     *
     * @param capacity the buffer capacity
     */
    ...
    /**
     * Returns a new {@link XClientMessageEvent.Buffer} instance allocated on the thread-local {@link MemoryStack} and initializes all its bits to zero.
     *
     * @param capacity the buffer capacity
     */
